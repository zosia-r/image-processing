# Audio Processing, Video Processing and Computer Vision - Lab Assignments

Lab assignments for the *Audio Processing, Video Processing and Computer Vision* course at Universidad Carlos III de Madrid.

## Labs

### Lab 1 - Image Processing Fundamentals
Introduction to core image processing concepts: histograms, color palettes, and low-pass filtering.  
**Tools:** `scikit-image`, `matplotlib`

### Lab 2 - Scale Space Blob Detection
...
**Tools:** `numpy`, `pytorch`, `matplotlib`, `torchvision`
