...
class RegionProposalNetwork(torch.nn.Module):
    ...
    def assign_targets_to_anchors(self, anchors, targets):
        ...
        for anchors_per_image, targets_per_image in zip(anchors, targets):
            ...
            if (gt_boxes.nelement() == 0):
                ...
                match_quality_matrix=torch.zeros([1,len(anchors[0])], dtype=torch.float32).to(device)
            else:
                match_quality_matrix = self.box_similarity(gt_boxes, anchors_per_image)
            matched_idxs = self.proposal_matcher(match_quality_matrix)
            if (gt_boxes.nelement() == 0):
                matched_gt_boxes_per_image=anchors[0]
            else:
    ...
    def filter_proposals(self, proposals, anchors, objectness, image_shapes, num_anchors_per_level):
        ...
        for boxes, scores, lvl, img_shape in zip(proposals, objectness, levels, image_shapes):
            ...
            anchors=anchors.squeeze(0)[keep,:]
        ...
        return final_boxes, final_scores, final_anchors
    ...
    def forward(self, images, features, targets=None):
        ...
        boxes, scores, anchors = self.filter_proposals(proposals, anchors, objectness, images.image_sizes, num_anchors_per_level)
